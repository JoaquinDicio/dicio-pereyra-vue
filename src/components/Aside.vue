...
<template>
    <aside class="flex flex-col justify-between border-r-2 text-white px-10 py-5 sm:max-w-96 ">
    <div>
        <nav>
            ...
            <ul class="space-y-4 mb-12 flex flex-col items-center">
                <li>
                    <router-link :to="`/home`" class="hover:font-medium transition flex justify-center md:justify-start min-w-[200px]">
                ...
                <li>
                    <router-link :to="`/explore`" class="hover:font-medium transition flex justify-center md:justify-start min-w-[200px]">
                        <div class="flex gap-5 items-center">
                ...
                <li>
                    <router-link :to="`/notifications`" class="hover:font-medium transition flex justify-center md:justify-start min-w-[200px]">
                        <div class="flex gap-5 items-center">
                ...
                <li>
                    <router-link :to="`/messages`" class="hover:font-medium transition flex justify-center md:justify-start min-w-[200px]">
                        <div class="flex gap-5 items-center">
                ...
                <li>
                    <router-link :to="`/saved`" class="hover:font-medium transition flex justify-center md:justify-start min-w-[200px]">
                        <div class="flex gap-5 items-center">
    ...
    <router-link v-if="user.id" :to="`/profile/${user.id}`" class="flex items-center gap-3 justify-center min-w-[100px]">
